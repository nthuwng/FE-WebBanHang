...
const ProductCreate = (props,searchTerm,onSearchChange
    ) => {
    const { loadProduct, isModalOpen, setIsModalOpen } = props;
        ...
        <div className="product-create">
          ...
          />
            ...
            <i className="search-icon">🔍</i>
                ...
                <Button className="add-button" onClick={() => setIsModalOpen(true)} type="primary">+ Thêm sản phẩm</Button>
            </div>
            </div>
                    ...
                    <div>
                        ...
                        <Select
                            ...
                            options={[
                                ...
                                { value: '67bf34eaaeb7bee632c4013e', label: 'Oppo' },
                                { value: '67bf34f8aeb7bee632c40140', label: 'Xiaomi' }
                            ]}
                        />
                    </div>
                </div>
